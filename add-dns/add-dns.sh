...
if [ -e $STAT_RESULT_FN ]; then
  ...
  echo "INFO: Now you should manually force a provisioning on the usg via the unifi controller. Try <a href='http://rpi-02-docker/cgi-bin/add-dns/add-dns.sh'>add-dns.sh</a>"
